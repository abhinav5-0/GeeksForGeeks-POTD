...
You will water them for **k days**.

* In one day, you can water **w continuous flowers**.
* Whenever you water a flower, its height increases by **1 unit**.
* You need to **maximize the minimum height** of all flowers after `k` days of watering.
...
Return the **maximum possible minimum height** of all flowers after `k` days of watering.
...
* **Greedy + Prefix/Difference Array Technique**

Time Complexity Target: **O(n log(maxHeight))**
